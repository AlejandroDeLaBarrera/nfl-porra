...
<head>
    ...
    <style>
        ...
        .nfl-button {
            ...
            box-shadow: 0 4px 12px rgba(214, 32, 39, 0.30);
        }

        .nfl-button:hover {
            background-color: #B91C1C;
            border-color: #B91C1C;
            box-shadow: 0 6px 16px rgba(214, 32, 39, 0.40);
        }
        ...
        .nfl-background {
            ...
            background-image:
                linear-gradient(rgba(6, 31, 50, 0.02),
                    rgba(6, 31, 50, 0.10)),
        ...
        a[href="{{ route('register') }}"] {
            ...
            box-shadow: 0 4px 12px rgba(214, 32, 39, 0.25);
...
<body class="bg-[#0B2416] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    ...
    <header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6 not-has-[nav]:hidden">
        ...
        <div style="display: flex; align-items: center; justify-content: space-between;">
            ...
            <div class="nfl-brand">
                <span class="nfl-brand-nfl">NFL</span>
                <span
                    style="
            width: 4px;
            height: 28px;
        ...
        "></span>
                <span class="nfl-brand-name">Pick'em all</span>
            </div>
    ...
    <div
        class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 starting:opacity-0 nfl-background">
    </div>
